...
@section('landing-page')
    ...
    <a href="#activities" class="position-absolute bottom-0 start-50 translate-middle-x mb-5 link-light"><svg id="scrl-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 38.9">
